      ...
      *****************************************************************
       ...
       SCREEN SECTION.
       01 RENTAL-SCREEN BLANK SCREEN PROMPT AUTO REQUIRED
       BACKGROUND-COLOR 0 FOREGROUND-COLOR 7.                          
         05 SCH-TITLE-LINE.
           10 LINE 1 COL 1 VALUE "MRS400".
         ...
         05 SCHEDULE-TITLE.
          10 LINE 2 COL 21
          VALUE "MOVIE RENTALS AND SCHEDULING: RENTALS".
         05 MAINTAIN-MOVIE.
           10 LINE 4 COL 25 VALUE "1: ADD RENTAL".
           10 LINE 6 COL 25 VALUE "2: DELETE RENTAL".
           10 LINE 8 COL 25 VALUE "3: UPDATE RENTAL".
           10 LINE 10 COL 25 VALUE "4: VIEW RENTAL".
       ...
       procedure divisioN.
           ...
           DISPLAY RENTAL-SCREEN
           ACCEPT RENTAL-SCREEN

           PERFORM 200-SCREENS THRU 200-EXIT
             UNTIL ((SCR-KEY = "1" AND F3) OR LS-OPTION = 6)
           goback.
       100-EXIT.
           exit.
      ...
      * display the corrisponding screen.
       300-EVALUATION.
           ...
           ELSE
               EVALUATE LS-OPTION
                   WHEN 1
                       CALL 'MRS-4100' USING LS-OPTION
                   WHEN 2
                       CALL 'MRS-4200' USING LS-OPTION
                   WHEN 3
                       CALL 'MRS-4300' USING LS-OPTION
                   WHEN 4
                       CALL 'MRS-4400' USING LS-OPTION
                   WHEN OTHER
                       DISPLAY SCH-ERROR
               END-EVALUATE
           END-IF.
